              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Image(image: AssetImage("assets/floyd.JPG"),height: 300,),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("void floydWarshall (int graph[][V])\n{"
                        "\n\tint dist[V][V], i, j, k; \n"
                        "\t\tfor (i = 0; i < V; i++)"
                        "\n\t\t\t\t for (j = 0; j < V; j++)\n"
                        "\t\t\t\t\t\t dist[i][j] = graph[i][j];\n"
                    ...
                    SelectableText("Worst Case: O(V^3)\n"
                        "Average Case: O(V^3)\n"
                        "Best Case: O(V^3)\n"
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Image(image: AssetImage("assets/kruskal.png"),height: 200.0,),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("MST-KRUSKAL(G,w)"
                        "\n1. A = ∅"
                    ...
                    SelectableText("Best Case: O(Elog(V))\n"
                        "Worst Case: O(Elog(V))\n"
              ...
              child: Container(
                ...
                child: ListView(
                  ...
                  "\n11. adj[u] = v if there is an edge from u to v that is (u, v)",
                    ...
                    Image(image: AssetImage("assets/prim.png"),height: 200.0,),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("Worst Case: O(Elog(V))\n"
                        "Average Case: O(Elog(V))\n"
                        "Best Case: O(Elog(V))\n",
                      style: TextStyle(fontSize: 25.0),)
                  ],
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Image(image: AssetImage("assets/dijkstra.jpg"),),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("Algorithm: DIJKSTRA(G,w,s)"
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Image(image: AssetImage("assets/bellman.jpg"),),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("BELLMAN-FORD(G,w,s)"
                                   "\n1. INITIALIZE-SINGLE-SOURCE(G,s)"
                                   "\n2. for i = 1 to |V| − 1"
                    ...
                    SelectableText("Worst Case: O(VE)\n"
                        "Average Case: O(VE)\n"
                        "Best Case: O(VE)\n",
                      style: TextStyle(fontSize: 25.0),)
                  ],
