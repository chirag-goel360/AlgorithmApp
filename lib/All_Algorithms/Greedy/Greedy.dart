              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Image(image: NetworkImage("https://www.studytonight.com/data-structures/images/activity-timeline.PNG"),height: 300,),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("Worst Case: O(nlogn)\n"
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Image(image: NetworkImage("https://www.geeksforgeeks.org/wp-content/uploads/fig-6.jpg"),height: 200.0,),
                    Align(
                      alignment: Alignment.center,
                      child: RichText(
                        text: TextSpan(
                    ...
                    SelectableText("Best Case: O(nlogn)\n"
                        "Worst Case: O(nlogn)\n"
                        "Average Case: O(nlogn)\n",
                      style: TextStyle(fontSize: 25.0),)
                  ],
