              ...
              child: Container(
                  ...
                  child: ListView(
                      children: <Widget>[
                        ...
                        new SelectableText("#include<iostream.h>\n#include<conio.h>\nvoid main(){\nclrscr();\nint arr[10], i, num, n, c=0, pos;\ncout<<''Enter the array size : '';\ncin>>n;\ncout<<''Enter Array Elements : '';\nfor(i=0; i<n; i++){\ncin>>arr[i];\n}\ncout<<''Enter the number to be search : '';\ncin>>num;\nfor(i=0; i<n; i++){\nif(arr[i]==num){\nc=1;\npos=i+1;\nbreak;\n}\n}\nif(c==0){\ncout<<''Number not found..!!'';\n}\nelse{\ncout<<num<<'' found at position ''<<pos;\n}\ngetch();\n}",
                          style: TextStyle(
                              fontSize: 18.0,
                              color: Colors.indigo
                          ),
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      Image(image: AssetImage("assets/BinarySearch.png"),height: 220.0,),
                      Align(
                        alignment: Alignment.center,
                        child: RichText(
                          text: TextSpan(
